...
const char* mqtt_Client = "8e1eaa03-144b-436f-be92-c7096ee1ba5d";  //อย่าลืมแก้ไข ClientID
const char* mqtt_username = "UDBUrGatRywev8u32oLZxjUkkf2iH767";  //อย่าลืมแก้ไข Token
const char* mqtt_password = "tNXT291cr1VmBtUmXpLjAS6L524c9CB5"; //อย่าลืมแก้ไข Secret
